...
const SerialIdPair SerialIdLookup[] =
{
	...
	{ {53,88,48,56,49,49,14,15,0,10,0 } , 78},	// Anchor station xmega (not used and assigned to Adam's ID)
	{ {53,88,48,56,49,49,14,15,0,7,0 } , 40}	// Rowan's second xmega (I hope this ID is not used)
};
