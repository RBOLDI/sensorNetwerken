...
uint8_t  FB_pipe[5] =	  {20, 19, 20, 20, 51};
uint8_t  RB_pipe[5] =	  {20, 19, 20, 20, 52};
uint8_t  SB_pipe[5] =	  {20, 19, 20, 20, 53};
uint8_t  JG_pipe[5] =	  {20, 19, 20, 20, 77};
uint8_t  AO_pipe[5] =	  {20, 19, 20, 20, 78};
